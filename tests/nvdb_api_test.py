...
class NVDBAPITester:
    ...
    def __init__(self):
        ...
        self.headers = {
            ...
            "X-Client": "demo.asset.inspection@test.com",  # Replace with your email
            "User-Agent": "DemoAssetInspection/1.0"
        }
        
        # Common Norwegian traffic sign feature types (these need verification)
        ...
        # Test coordinates (Oslo area - adjust for your target region)
